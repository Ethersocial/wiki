...
* 최초에 5,000,000ESN이 발행되어 이더소셜 포럼(땡글)에서 사용하기 위한 적립금으로 비축하며 매년 일정하게 분배한 다음 8,000,000 ESN을 추가 발행하여 포럼 협업 및 마케팅을 위해 이더소셜 포럼(땡글)에 적립한다. 그리고 36,922,490 ESN을 추가 발행하여 이더소셜 런칭 전의 초기 기여자들과 이더소셜 개발을 위한 개발 비용으로 적립하며 이더소셜 개발조직(Geminis)에게 분배된다.
