...
* In the beginning, 5,000,000 ESN are issued to be accumulated as a reserve for EtherSocial (DDengle) and are constantly distributed every year. Then, 8,000,000 ESN will be additionally issued to be reserved in the EtherSocial forum (DDengle) for collaboration and marketing of the forum. Again 36,922,490 EtherSocial will be additionally issued to be reserved for initial prior-to-launch donators and for development expenses of EtherSocial, and to be distributed to EtherSocial's development organization.
